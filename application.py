...
# Returns if file is one of the allowed file extensions
...
def transformData():
    ...
    if request.method == 'POST':
         ...
         if f and allowed_file(f.filename):
            ...
            # Converts dataset to all numerical values based on the categorical values
...
# TODO
# Add error catching for wrong delimiters
